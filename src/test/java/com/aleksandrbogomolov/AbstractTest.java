...
public abstract class AbstractTest {
    ...
    protected final User testUser1 = new User(String.valueOf(startId + 1), "test", "test1@mail.ru", "test", 2000, true, LocalDate.of(2016, 11, 7), new HashSet<>(Collections.singletonList(Role.ROLE_USER)));
